                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <a target="_blank" href="<?php echo base_url() ?>Outbound/Outbound/edit?phone=<?php echo $datana->no_pstn; ?>&ncli=<?php echo $datana->ncli; ?>"><span class="btn btn-sm btn-primary"><?php echo $datana->ncli; ?></span></a>
                                </td>
