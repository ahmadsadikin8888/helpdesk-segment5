                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url() ?>Outbound/Outbound/edit?idx=<?php echo $datana['idx'] ?>&phone=<?php echo $datana['no_pstn']; ?>&ncli=<?php echo $datana['ncli']; ?>&hp=<?php echo $datana['no_handpone']; ?>"><span class="btn btn-sm btn-primary"><?php echo $datana['ncli']; ?></span></a>
                            </td>
            ...
            $.ajax({
                ...
                success: function(results) {
                    ...
                    if(results > 0){
                        ...
                        $("#lblatas").show();
                        $("#title_app").text("( "+results+" ) NEW DATA MOSS | Sy-ANIDA");
