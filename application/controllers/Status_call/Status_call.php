...
class Status_call extends CI_Controller {
   private $log_key,$log_temp,$title;
   function __construct(){
        parent::__construct();
		$this->load->model('Status_call/Status_call_model','tmodel');
		$this->log_key ='log_Status_call';
		$this->title = new Status_call_config();
   }
	...
	public function index(){
		...
		$this->template->load('Status_call/Status_call_list',$data);
	}
