...

				{
					...
					render: function(data, type, row) {
						if (type === 'display') {
							var konfirm = '';
							var btn_group = '';
							btn_group = btn_group + '<a href="<?php echo $link_update ?>/' + row.idx + '" class="btn btn-default text-red btn-sm " title="update"><i class="fa fa-edit"></i></a>';
							
							
								//btn_group = btn_group + '<button type="button" class="btn btn-default text-red btn-sm"  id="btn_pre_delete" onclick=\' ybsDeleteTable("' + row.idx + "-" + konfirm + '","<?php echo $link_delete ?>","#table-detail") \'  ><i class="fa fa-trash-o"></i></button></small>';
